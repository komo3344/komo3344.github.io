...
```
drf_jwt에서 제공되는 함수들을 이용하여 endpoint를 작성한다.  
(아래코드를 참조)
...
```
DB모델링은 models.py에서 작업한다. 간단한 유저모델만 만들어보자
...
![alt text]({{site.url}}/{{site.baseurl}}/assets/images/django/postman1.png)  
![alt text]({{komo3344.github.io}}/{{site.baseurl}}/assets/django/postman1.png)  
![alt text]({{komo3344.github.io}}/{{site.baseurl}}/assets/django/postman1.png)  
...
![alt text]({{komo3344.github.io}}/{{site.baseurl}}/assets/images/django/postman2.png)
***
...
이로써 회원가입, 로그인을 통하여 access token을 받을 수 있기 때문에  
유저가 다른 어떤 Resource를 사용할 준비가 되었다.
